...
exports.default = _default;
},{"../components/modal/freeLesson/FreeLesson":"components/modal/freeLesson/FreeLesson.js"}],"components/registration/enterWindow.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var FormEnter = /*#__PURE__*/function () {
  function FormEnter() {
    _classCallCheck(this, FormEnter);
    this.checker = document.querySelector('.registration__checker');
    this.mask = '';
  }
  _createClass(FormEnter, [{
    key: "sendForm",
    value: function sendForm() {
      var _this = this;
      var form = document.querySelector('.form-send');
      var container = document.querySelector('.container-send');
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                if (error == 0) {
                  ...
                  setTimeout(function () {
                    var response = fetch('sendmail.php', {
                      // адрес сервера для отправки запроса
                      method: 'POST',
                      body: formData
                    });
                    if (response.ok) {
                      ...
                      formReq.forEach(function (input) {
                        if (input.classList.contains('modal__input_name')) {
                          ...
                          if (_this.checker) {
                            if (_this.checker.getAttribute('checked')) {
                      ...
                      var _formReq = document.querySelectorAll('._form__req');
                      _formReq.forEach(function (input) {
                        if (input.classList.contains('modal__input_name')) {
                          input.placeholder = 'Логин';
                          if (_this.checker) {
                            if (_this.checker.getAttribute('checked')) {
    ...
    key: "chekerListener",
    value: function chekerListener() {
      var _this2 = this;
      if (this.checker) {
        this.checker.addEventListener('click', function () {
          if (_this2.checker.getAttribute('checked')) {
            _this2.checker.removeAttribute('checked');
          } else {
            _this2.checker.setAttribute('checked', 'true');
          }
        });
      }
    }
    ...
    key: "autoFillLogin",
    value: function autoFillLogin() {
      var input = document.querySelector('.modal__input_name');
      if (localStorage.getItem('login') && !input.classList.contains('_register')) {
        var inputValue = localStorage.getItem('login');
...
;
var callThisFunc = new FormEnter();
callThisFunc.maskForPhone();
callThisFunc.sendForm();
callThisFunc.chekerListener();
callThisFunc.autoFillLogin();
},{"../../technicalFunctions/TechnicalFunctions":"technicalFunctions/TechnicalFunctions.js","imask":"node_modules/imask/esm/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/registration/enterWindow.js"], null)
//# sourceMappingURL=/enterWindow.9a946220.js.map