    ...
    value: function openSubTitle() {
      ...
      document.addEventListener('click', function (event) {
        ...
        if (vector.style.transform != 'rotate(-180deg)') {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              teacher.nextElementSibling.classList.add('hidden__question');
        ...
        if (vector.id != 'vector4') {
          ...
          _target.classList.toggle('hidden__question');
          if (_target.classList.contains('hidden__question')) {
            vector.style.transform = 'rotate(0deg)';
            teachers[0].classList.remove('unvisible__alex');
            teachers[0].classList.add('visible__alex');
          } else {
...
exports.default = _default;
},{"../../technicalFunctions/TechnicalFunctions":"opYb"}],"kqCf":[function(require,module,exports) {
"use strict";
...
function Observer(_ref) {
  ...
  const init = () => {
    ...
    if (swiper.params.observeParents) {
      const containerParents = (0, _utils.a)(swiper.el);
...
},{"./shared/swiper-core.mjs":"MzqK"}],"FGIR":[function(require,module,exports) {
"use strict";
...
var MySwiper = /*#__PURE__*/function () {
  ...
  _createClass(MySwiper, [{
    ...
    value: function addInitialization() {
      ...
      this.programSwiper = new _swiper.default('.program-swiper-container', {
        loop: true,
        breakpoints: {
          480: {
            slidesPerView: 1
...
exports.default = _default;
},{"swiper":"ZxYy"}],"Focm":[function(require,module,exports) {
"use strict";
...
var _header = _interopRequireDefault(require("./components/1header/header.js"));
var _MySwiper = _interopRequireDefault(require("./components/MySwiper/MySwiper.js"));
var _FreeLesson = _interopRequireDefault(require("./components/modal/freeLesson/FreeLesson.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
document.addEventListener('DOMContentLoaded', function () {
  ...
  _MySwiper.default.addInitialization();
});
},{"./components/questions/questions.js":"xf2P","./components/form/Form.js":"mrum","./components/teachers/Teachers.js":"ELIx","./components/footer/Footer.js":"pwXZ","./technicalFunctions/TechnicalFunctions.js":"opYb","./components/1header/header.js":"kqCf","./components/MySwiper/MySwiper.js":"FGIR","./components/modal/freeLesson/FreeLesson.js":"mjn2"}]},{},["Focm"], null)